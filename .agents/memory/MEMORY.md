...
- [EAS iOS submit authentication](eas-ios-submit-auth.md) — use one Apple auth method; a conflict after a clean pushed build indicates stale server-side EAS submit credentials
